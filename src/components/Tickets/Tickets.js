    ...
    return (
        <section id="Tickets">
            ...
            <div className="tickets_div">
                <div id='card1' className="tickets_card_1">
                    ...
                    <button class="get_tickets" className="tickets_card_1_btn">Free download</button>
                </div>
                <div className="tickets_card_2_div">
                    ...
                    <button class="get_tickets" className="tickets_card_2_btn">Free trial</button>
                </div>
                <div className="tickets_card_3_div">
                    ...
                    <button class="get_tickets" className="tickets_card_3_btn">Free trial</button>
                </div>
            </div>
        </section>
    );
